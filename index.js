...
// I think that it can access the variable internal because it is within the same scope of the myFunction.
...
//  console.log('This is summation', summation(100));
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimalsData) { 
    const displayNames = [];
    zooAnimalsData.forEach(animal => {
      displayNames.push( `name: ${animal.animal_name}, scientific: ${animal.scientific_name}`);
    });
    return displayNames;
  }
  // console.log('Request 1 - Complete', animalNames(zooAnimals));
  ...
  */
  ...
  // const zooAnimalsLC = zooAnimals.map(lowerCaseNames);

  function lowerCaseNames(zooAnimalsData){
    const zooAnimalsLC = zooAnimalsData.map((zooAnimalsData) => {
      return zooAnimalsData.animal_name.toLowerCase();
    });
    return zooAnimalsLC;
  }
  
  // console.log('Request 2 - Incomplete', lowerCaseNames(zooAnimals));
  ...
  */
  ...
  // const lessThanFive = zooAnimals.filter(lowPopulationAnimals => { return zooAnimalsData <= 5 });

  function lowPopulationAnimals(zooAnimalsData){
    return zooAnimalsData.filter((animal) => animal.population < 5);
  }

  function lowPopulationAnimals2(zooAnimalsData) {
    return zooAnimalsData.filter(function(animal) {
  ...
  */
  ...
  function USApop(zooAnimalsData){
    const addedSum = zooAnimalsData.reduce((accumulator, currentValue) => {
...
function seatingTables(a, b) {
  return `Hello ${a}, table for ${b}?`;
}
  ...
  // console.log(seatingTables('sir', 2));
  // console.log('Step 1 - consume', consume('sir', 2, seatingTables));
...
function add(num1, num2){
  ...
  // console.log('Step 2 - Add', add(2, 5));
...
function multiply(num1, num2){
  ...
  // console.log('Step 2 - Multiply', multiply(2, 5));
...
function greeting(firstName, lastName){
  ...
  // console.log('Step 2 - Greeting', greeting('Devon', 'McGrath'));
...
// CuboidMaker.prototype.statusCheck = function() {
  
// }

// console.log('Step 1: Base Constructor', CuboidMaker());
...
// console.log('Step 2: Volume Method', volume);
// console.log('Step 2: Volume Method', volume.volumeMath());
...
// const surfaceArea = function (length, width, height) {
//   return ((length * width) + (length * height) + (width * height));
// }

// const surfaceArea = new CuboidMaker({
//   length: 2,
//   width: 2,
//   height: 2
// });

// console.log('Step 3: Surface Area Method', surfaceArea.surfaceAreaMath());
